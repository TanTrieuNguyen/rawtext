if getgenv().cuppink then warn("TT1403 Hub : Already executed!") return end
...
local Window = Fluent:CreateWindow({
    Title = game:GetService("MarketplaceService"):GetProductInfo(16732694052).Name .." | TanTrieuNguyen - Premium",
    SubTitle = "(tiktok.com/@victortrieu2k11)",
    TabWidth = 160,
...
do
    Tabs.Home:AddButton({
        ...
        Description = "Follow my account!",
        Callback = function()
            setclipboard("https://tiktok.com/@victortrieu2k11")
        end
    })
